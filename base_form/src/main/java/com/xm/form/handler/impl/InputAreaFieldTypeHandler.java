...
public class InputAreaFieldTypeHandler implements ExternalFieldTypeHandler {

    private final TcFormDynamicFieldService dynamicFieldService;

    @Override
    public String getFieldType() {
        return FormFieldTypeEnum.INPUT_AREA.getValue();
    }
    ...
    public void saveData(TcFormDetailModel detailModel, String formInsId,
        ...
        if (object instanceof String){
            String bigText=object.toString();
            TcFormDynamicField dynamicField=new TcFormDynamicField();
            dynamicField.setFieldBigText(bigText);
    ...
    public void getData(TcFormDetailModel detailModel,String formInsId, String refId, String refType, Map<String, Object> data) {
        ...
        String fieldBigText = dynamicField.getFieldBigText();
        if (StrUtil.isNotBlank(fieldBigText)){
            data.put(detailModel.getFieldCode(),fieldBigText);
        }
    }
